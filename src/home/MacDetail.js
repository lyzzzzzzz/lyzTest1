...
export default class MacDetail extends Component {
  ...
  searchAll = () => {
    //获取商品列表
    fetch(baseUrl + '/product/selectProductByBrand?product_brand=mac', {
      method: 'GET',
      headers: new Headers({
  ...
  searchText = () => {
    //获取商品列表
    fetch(baseUrl + '/product/SelectProductBaseBrand?productBrand=mac&searchText=' + this.state.text, {
      method: 'GET',
      headers: new Headers({
        'Content-Type': 'application/json'
      })
