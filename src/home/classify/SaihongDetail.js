...
class SaihongDetail extends Component {
  ...
  searchText = () => {
    //获取商品列表
    fetch(baseUrl + '/product/SelectProductBaseType?productType=腮红&searchText=' + this.state.text, {
      method: 'GET',
      headers: new Headers({
  ...
  searchAll = () => {
    //获取商品列表
    fetch(baseUrl + '/product/mySelectProductByType?productType=腮红', {
      method: 'GET',
      headers: new Headers({
        'Content-Type': 'application/json'
      })
